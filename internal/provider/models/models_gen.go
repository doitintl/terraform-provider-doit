...
const (
	Single SingleAllocationAllocationType = "single"
)
...
// CreateAllocationJSONBody defines parameters for CreateAllocation.
type CreateAllocationJSONBody struct {
	union json.RawMessage
}

// UpdateAllocationJSONBody defines parameters for UpdateAllocation.
type UpdateAllocationJSONBody struct {
	union json.RawMessage
}
...
type CreateAllocationJSONRequestBody CreateAllocationJSONBody

// UpdateAllocationJSONRequestBody defines body for UpdateAllocation for application/json ContentType.
type UpdateAllocationJSONRequestBody UpdateAllocationJSONBody
