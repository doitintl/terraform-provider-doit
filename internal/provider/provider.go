...
func (p *doitProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewAnomalyExplanationDataSource,
		NewInvoiceDataSource,
		NewBillingExplainerDataSource,
		...
		NewPs4cGcpRecommendationDataSource,
		NewPs4cCommitmentPolicyDataSource,
		// List data sources
		...
		NewCloudDiagramsSnapshotsDataSource,
		NewCloudDiagramsSnapshotDataSource,
		...
		NewCloudDiagramsExportDataSource,
		NewCloudDiagramsNodeActivitiesDataSource,
		NewCloudDiagramsRelationshipsDataSource,
		...
		NewPs4cGcpPlannedPurchasesDataSource,
		NewPs4cGcpSpendCudsDataSource,
		NewPs4cGcpRecommendationsDataSource,
