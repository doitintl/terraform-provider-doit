...
import (
	...
	"github.com/doitintl/terraform-provider-doit/internal/provider/datasource_cloud_diagrams_snapshot"
...
var _ datasource.DataSource = (*cloudDiagramsSnapshotDataSource)(nil)
var _ datasource.DataSourceWithConfigure = (*cloudDiagramsSnapshotDataSource)(nil)

// NewCloudDiagramsSnapshotDataSource creates a new instance of the data source.
func NewCloudDiagramsSnapshotDataSource() datasource.DataSource {
	return &cloudDiagramsSnapshotDataSource{}
}

// cloudDiagramsSnapshotDataSource implements datasource.DataSource.
type cloudDiagramsSnapshotDataSource struct {
	client *models.ClientWithResponses
}

// cloudDiagramsSnapshotDataSourceModel is the Terraform state model.
type cloudDiagramsSnapshotDataSourceModel struct {
...
func (d *cloudDiagramsSnapshotDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cloud_diagrams_snapshot"
}

func (d *cloudDiagramsSnapshotDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	genSchema := datasource_cloud_diagrams_snapshot.CloudDiagramsSnapshotDataSourceSchema(ctx)
...
func (d *cloudDiagramsSnapshotDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *cloudDiagramsSnapshotDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data cloudDiagramsSnapshotDataSourceModel
