...
package datasource_ps4c_gcp_recommendations
...
func Ps4cGcpRecommendationsDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"page_token": schema.StringAttribute{
				...
				MarkdownDescription: "Reserved for pagination. Currently always `null`.",
			},
			"region": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"row_count": schema.Int64Attribute{
				...
				MarkdownDescription: "Number of recommendations returned in `items`.",
			},
		},
...
type Ps4cGcpRecommendationsModel struct {
