...
package datasource_cloud_diagrams_snapshot
...
func CloudDiagramsSnapshotDataSourceSchema(ctx context.Context) schema.Schema {
...
type CloudDiagramsSnapshotModel struct {
