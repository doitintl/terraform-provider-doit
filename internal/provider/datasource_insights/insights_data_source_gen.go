...
func (t ResultsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	dismissalDetailsAttribute, ok := attributes["dismissal_details"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`dismissal_details is missing from object`)
	...
	return ResultsValue{
		...
		DismissalDetails:       dismissalDetailsVal,
...
func (v ResultsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["dismissal_details"] = DismissalDetailsType{
		basetypes.ObjectType{
			AttrTypes: DismissalDetailsValue{}.AttributeTypes(ctx),
		},
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DismissalDetails.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["dismissal_details"] = val
...
func (v ResultsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var dismissalDetails attr.Value

	{
		dismissalDetails = v.DismissalDetails
	}
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"dismissal_details": DismissalDetailsType{
				basetypes.ObjectType{
					AttrTypes: DismissalDetailsValue{}.AttributeTypes(ctx),
				},
			},
...
func (v ResultsValue) Equal(o attr.Value) bool {
	...
	if !v.DismissalDetails.Equal(other.DismissalDetails) {
		return false
	}
