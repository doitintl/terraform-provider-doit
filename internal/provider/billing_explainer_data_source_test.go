		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.doit_billing_explainer.test", "payers.630855515779.summary.aws.marketplace_charges.#"),
					resource.TestCheckResourceAttrSet("data.doit_billing_explainer.test", "payers.630855515779.summary.doit.marketplace_charges.#"),
					resource.TestCheckResourceAttrSet("data.doit_billing_explainer.test", "payers.630855515779.summary.aws_without_doit.marketplace_charges.#"),
				),
			},
