...
- **data-source/doit_report_query, data-source/doit_report_result**: Opt into async execution with `async = true`, including polling, time-range overrides, and best-effort cancellation on interruption. Synchronous execution remains the default.
